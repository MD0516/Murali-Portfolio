  ...
  return (
    <div>
      <div className='d-flex justify-content-center align-items-center gap-3 mobile-nav ' >
        <Link to='/explore' className={`${tab === '' || "explore" || tab === '' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center`} onClick={window.scrollTo({ top: 0, behavior: 'smooth' })}>
