  ...
  return (
    <div>
        <div className='d-flex justify-content-center align-items-center gap-3 mobile-nav ' >
            ...
            <Link to='/skills' className={`${current === 'skills' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center`} onClick={window.scrollTo({ top:0, behavior: 'smooth' })}>
            ...
            <Link to='/projects' className={`${current === 'projects' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center`} onClick={window.scrollTo({ top:0, behavior: 'smooth' })}>
            ...
            <Link to='/about' className={`${current === 'about' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center`} onClick={window.scrollTo({ top:0, behavior: 'smooth' })}>
            ...
            <Link to='/contact' className={`${current === 'contact' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center `} onClick={window.scrollTo({ top:0, behavior: 'smooth' })}>
