...
const MobileNav = () => {
  ...
  return (
    <div>
        <div className='d-flex justify-content-center align-items-center gap-2 mobile-nav ' >
            <Link to='/explore' className={`${current === 'explore' || current === '' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center`}>
            ...
            <Link to='/skills' className={`${current === 'skills' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center`}>
            ...
            <Link to='/projects' className={`${current === 'projects' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center`}>
            ...
            <Link to='/about' className={`${current === 'about' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center`}>
            ...
            <Link to='/contact' className={`${current === 'contact' ? 'mobile-active' : ''} d-flex flex-column gap-1 justify-content-center align-items-center `}>
