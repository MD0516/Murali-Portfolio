...
const Sidebar = () => {
  ...
  return (
    <>
      { !toggleSidebar && <div className='d-flex flex-column gap-3 align-items-center sidebar  p-4'  >

          <div className='rounded-circle bg-white d-flex justify-content-center align-items-center' style={{width: '200px', height: '200px'}}> Profile Pic</div>
          ...
          <div className='d-flex gap-3 custom-hover'>
          ...
          <div className='d-flex flex-column gap-3 nav' >
            ...
            <Link to='/about' className={`${current === 'about' ? 'active' : ''} d-flex gap-2 justify-content-start align-items-center`}>
      ...
      <div className={`${toggleSidebar ? 'left-toggled' : 'left-toggle'} d-flex justify-content-center align-items-center`} onClick={handleSidebar}>
        { !toggleSidebar ? (
      ...
      {toggleSidebar && <div className='d-flex flex-column gap-3 align-items-center toggled-sidebar p-4'  >

          <div className='rounded-circle bg-white d-flex justify-content-start align-items-center' style={{width: '40px', height: '40px'}}> </div>          
