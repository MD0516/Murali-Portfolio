...
import arkfaLms from '../Assets/Screenshots/arkfa-lms.png'
  ...
  const projects = [
    {
      ...
      link: 'https://arkfa.net/',
    },
    {
      logo: arkfaLms,
      title: 'ARKFA LMS',
      description: 'Learning Management System (LMS) platform currently under development — designed for course management, student enrollment, and attendance tracking',
      technologies: ['React', 'PHP', 'Laravel', 'PostgreSQL'],
      link: null
    }
  ]
                    ...
                    {animateNow && <motion.div initial={{ opacity: 0, x: fromDir }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: i * 0.1, ease: 'easeInOut' }} viewport={{ once: true }} className='project-card col-12 col-md-6 ' key={i}>
                      ...
                      <div className='project-description'>
                        ...
                        <div className='project-link p-2'>
                          {item.link == null ? <span className=''> Live Demo Unavailable </span> :
